...
public class NodeCacheTest {
    ...
    public static void main(String[]args){
        ...
        try {
            ...
            client.start();
            cache = new NodeCache(client, Constants.CACHE_PATH);
            cache.start();
    ...
    private static void remove(CuratorFramework client) throws Exception {
        try {
            client.delete().forPath(Constants.CACHE_PATH);
    ...
    private static void setValue(CuratorFramework client, String command, String[] args) throws Exception {
        ...
        try {
            client.setData().forPath(Constants.CACHE_PATH, bytes);
        } catch (KeeperException.NoNodeException e) {
            client.create().creatingParentsIfNeeded().forPath(Constants.CACHE_PATH, bytes);
        }
    }
